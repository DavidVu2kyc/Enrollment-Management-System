      ...
      >
        <div class="course-meta">
          <span class="course-code"
            >{enrollment.section?.course?.code ?? "—"}</span
          >
          <span class="meta-sep">·</span>
          <span class="section-code"
            >§ {enrollment.section?.sectionCode ?? "—"}</span
          >
          {#if credits}
            <span class="meta-sep">·</span>
            <span class="credits"
              >{credits} {credits === 1 ? "unit" : "units"}</span
            >
          {/if}
        </div>
  ...
  >
    ...
    >
      ...
      <div class="modal-course">
        <div class="modal-course-code">
          {enrollment.section?.course?.code} · § {enrollment.section
            ?.sectionCode}
        </div>
      ...
      <div class="modal-warning">
        ...
        <p>
          Dropping this course will remove your seat reservation and may affect
...
<style>
  ...
  .card.enrolled {
    --stripe-color: var(--c-green);
  }
  .card.pending {
    --stripe-color: var(--c-amber);
  }
